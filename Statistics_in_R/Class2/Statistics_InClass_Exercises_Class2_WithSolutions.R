...
# Find mean prescribing rate for south
mean.pres.south <- mean(opioid.south$prescribing.rate, na.rm = T)
# Find prescribing standard deviation
sd.pres.south <- sd(opioid.south$prescribing.rate, na.rm = T)

# Finding the zscore of a prescribing.rate of 70 prescriptions per 100 individuals
zscore.prescribe.105.south <- (105 - mean.pres.south)/sd.pres.south
zscore.prescribe.105.south

# Using the above example, find the zscore of a overdose.rate of 20 in opioid.south

# Find mean overdose rate
mean.od.south <- mean(opioid.south$overdose.rate, na.rm = T)
# Find overdose rate standard deviation
sd.od.south <- sd(opioid.south$overdose.rate, na.rm = T)

# Finding the zscore of a overdose.rate of 15 per 100,000 individuals
zscore.overdose.20.south <- (20 - mean.od.south)/sd.od.south
zscore.overdose.20.south
